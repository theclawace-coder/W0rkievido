...
// Uses smartleadId to fetch from SmartLead API, caches in Supabase
app.get('/api/leads/:leadId/emails', async (req, res) => {
  ...
  // Fetch fresh from SmartLead using the actual smartlead_id
